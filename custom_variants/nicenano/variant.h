...
#define PIN_WIRE_SDA (PIN_104)
#define PIN_WIRE_SCL (PIN_106)

#define SPI_INTERFACES_COUNT 1

#define PIN_SPI_MISO (PIN_115)
#define PIN_SPI_MOSI (PIN_113)
#define PIN_SPI_SCK  (PIN_111)
